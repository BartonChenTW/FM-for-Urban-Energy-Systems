...
- **Filling a stub.** [Part 4](../part-4-directions/index.html) contains several sections marked "Stub — needs expansion" ([§4.1](../part-4-directions/4-1-off-the-shelf-fms.html), [§4.2](../part-4-directions/4-2-fms-for-building-stocks.html), [§4.3](../part-4-directions/4-3-llm-agents-for-simulation.html), [§4.4](../part-4-directions/4-4-generative-design.html)). These are exactly the sections most likely to benefit from someone who knows a specific corner of that direction well.
...
---
[← Previous: 6.1 Open Gaps](6-1-open-gaps.html) · [Back to Part 6](index.html) · [Back to Home](../index.html)

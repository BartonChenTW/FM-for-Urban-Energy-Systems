...
- **Topology variety** — bipartite graphs with varying numbers of carrier-buses and devices, varying port connectivity, so the model does not overfit to one district's specific graph shape (this is the direct analogue of the topology-generalisation claim in [§4.9.2](../part-4-directions/4-9-2-methods-tier2.html)).

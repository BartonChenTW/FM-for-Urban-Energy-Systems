...
Applying the general physics-enforcement mechanisms from [§4.10.2](../part-4-directions/4-10-building-it.html#4102-enforcing-physics) to the token schema of [§5.5](5-5-token-schema.html), the physics loss for this representation covers:

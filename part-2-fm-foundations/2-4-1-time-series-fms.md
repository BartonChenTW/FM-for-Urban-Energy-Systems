...
{: .note }
Using these models off the shelf, zero-shot, for load forecasting is covered as a practical direction in [§4.1](../part-4-directions/4-1-off-the-shelf-fms.html), and as a build path in [§4.9.1 (Tier 1)](../part-4-directions/4-9-1-methods-tier1.html).

...
**R4 — Building as an element of a stock.** Individual buildings as the basic element within a portfolio. Suits stock-level questions; gives up within-building resolution. See also [§4.2](../part-4-directions/4-2-fms-for-building-stocks.html) for FMs targeting whole building stocks specifically.

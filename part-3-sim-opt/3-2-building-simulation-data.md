...
- **ResStock / ComStock** (NREL) — large-scale, physics-based housing and commercial building stock models producing simulated hourly load data with full building metadata, widely used as pretraining or benchmarking corpora for building-stock-scale work (see [§4.2](../part-4-directions/4-2-fms-for-building-stocks.html)).

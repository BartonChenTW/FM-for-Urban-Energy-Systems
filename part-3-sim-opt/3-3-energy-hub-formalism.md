...
This is the classical-formalism counterpart to the representation problem developed at length in [§5.2](../part-5-case-study/5-2-representation-problem.html) — the energy hub gives humans and solvers a working formalism; it does not by itself give a learned model a basic element.

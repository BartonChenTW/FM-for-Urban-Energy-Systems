...
Each row is a distinct *task* with a distinct mathematical structure — and foundation-model potential differs sharply between them. This table is used again in [§4.6 Screening the Tasks](../part-4-directions/4-6-screening-tasks.html).
...
{: .note }
T1 also carries a representation problem the other tasks do not, because the decomposition of a building into elements is itself a modelling choice rather than a property of the object. See [§2.3 Choosing a Basic Element](../part-2-fm-foundations/2-3-choosing-a-basic-element.html).
...
---
[← Back to Part 3](index.html) · [Next: 3.2 Building Energy Simulation →](3-2-building-simulation-data.html)

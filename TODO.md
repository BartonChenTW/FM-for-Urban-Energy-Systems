...
- [ ] **The existing chapter-landing diagrams aren't very helpful (Barton, 2026-09-12).** All six are flowcharts of the table of contents — boxes with section numbers and titles, connected by "comes after" arrows — which is the same information the sidebar nav and the "In this chapter" table already give. See [diagram-ideas.md](diagram-ideas.md) for a page-by-page critique and concrete replacement ideas (e.g. Chapter 4's landing diagram could be the actual screening funnel/2×2 instead of a TOC; Chapter 5's could promote the bipartite-graph worked example from §5.4). One quick fix already applied: Chapter 4's diagram had wrong section numbers (§4.9–4.12 instead of the real §4.5–4.10) — corrected 2026-09-12, independent of the bigger redesign question.

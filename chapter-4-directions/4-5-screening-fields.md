...
| :--- | :--- | :--- | :--- | :--- |
| **Load / smart-meter FM** | Windowed patch of a meter time series | Masked / next-value reconstruction | EnergyBench, BuildingsBench (see [§3.2](../chapter-3-sim-opt/3-2-building-simulation-data.html)) | Mature — several such models already exist |

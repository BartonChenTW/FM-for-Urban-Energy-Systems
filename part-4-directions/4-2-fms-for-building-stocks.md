...
- A worked comparison of stock-level versus building-level representation against the four requirements in [§2.3.1](../part-2-fm-foundations/2-3-choosing-a-basic-element.html#231-the-criterion), analogous to the building-level analysis already done in [§2.3.2](../part-2-fm-foundations/2-3-choosing-a-basic-element.html#232-basic-elements-for-buildings).

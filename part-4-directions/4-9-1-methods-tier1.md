...
This is a well-studied shape (see [§3.4](../part-3-sim-opt/3-4-dispatch-optimisation.html)). You are choosing and adapting an architecture, not inventing one.
...
**Cross-variate (recommended).** Carriers attend to each other (see [§2.7](../part-2-fm-foundations/2-7-architectures.html) for what attention does). Two reference implementations:
